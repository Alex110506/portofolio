...
const rederText = (text, className, baseWeight) => {
...
const Welcome = () => {
  ...
  return (
    <section id='welcome'>
      <p ref={subTitleRef}>
        {rederText("Hey, I'm Alex! Welcome to my", "text-3xl font-georama", 100)}
      </p>
      <h1 ref={titleRef} className='mt-7'>
        {rederText("portofolio", 'text-9xl italic font-georama', 400)}
      </h1>
